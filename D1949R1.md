...
Homoglyph attacks, where visually indistinguishable characters from different scripts are used to create confusion, such as between latin letter c and cyrillic letter c. This is covered by Unicode Technical Report #36 [UNICODE SECURITY CONSIDERATIONS](http://www.unicode.org/reports/tr36/). It requires much more extensive analysis of text, and for a compiled language would provide limited benefit.
