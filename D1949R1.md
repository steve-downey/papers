...
Detection of un-normalized text is fairly straignt-forward, and GCC 10 already produces a warning. Normalizing to NFC is not much more difficult. SG16 is weakly in favor of making source not in NFC ill-formed, with a diagnostic required. However, we need feedback from implementers, particularly since this is a potentially breaking change.
