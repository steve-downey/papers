...
We are working with the Unicode Consortium and the ISO project for 10646 to
...
::: add
> A _named-universal-character_ designates the character in the translation
> character set
>
> - whose associated character name or character name alias as specified in ISO/IEC 10646 clause 34 or
> - whose control code alias in table X
>
> is the given _n-char-sequence_.
>   The program is ill-formed if there is no such
> character.
:::

::: add
>
> Note: The following aliases are provided for control characters which
> otherwise have no associate character name or character name alias. These
> names are derived from the Unicode Character Database's NameAliases.txt. For
> historical reasons the C0 and C1 control characters are formally unnamed.
