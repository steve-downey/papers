...
- Add cross-references from the Annex to the main text where the normative statement appears.
- Add normative reference to UAX 31
- Add normative reference to UAX 44 for XID properties
- add subclause and paragraph numbers (alongside the stable name for the subclause) based on an identified IS working draft.
- diff.cpp20.lex "affected subclause" 5.10: also add section label
- lex.name should refer to UAX 44 for properties
...
C++ does not use identifiers to describe patterns.
...
>
> **Effect on original feature**: Identifiers are now validated according to ISO/IEC 10646 recommended methods. Identifiers that contain invisible characters are not allowed.
>:::
...
::: add
>
> # Annex X: Design choices in application of UAX #31 - Informative Only
>
...
>
> Format characters are not additionally restricted beyond what UAX #31 provides.
>
> [X.1.2]{.pnum} R1b. Stable Identifiers
>
> No explicit stability guarantees beyond what is provided by UAX #31.
>
